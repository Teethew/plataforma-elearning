...
INSERT INTO trilhas(id, owner, nome, descricao, categoria, capa) VALUES(1, 1, 'Teoria dos Grafos', 'Trilha de estudos para a matéria Teoria dos Grafos', 'Ciência da computação', 'https://i.imgur.com/plms1Um.jpg');
INSERT INTO trilhas(id, owner, nome, descricao, categoria, capa) VALUES(2, 2, 'Sistemas Operacionais', 'Trilha de estudos para a matéria Sistemas Operacionais', 'Ciência da computação', 'https://i.imgur.com/VEtkTXc.png');
INSERT INTO trilhas(id, owner, nome, descricao, categoria, capa) VALUES(3, 2, 'Rust desbravado', 'Desbravando Rust com diversos exemplos práticos', 'Engenharia de sistemas', 'https://i.imgur.com/yUPdXs3.png');
...
INSERT INTO videos(id, nome, url, id_trilha) VALUES (3, 'Algoritmo do menor caminho (en-US)', 'https://www.youtube.com/watch?v=pVfj6mxhdMw', 1);
INSERT INTO videos(id, nome, url, id_trilha) VALUES (2, 'Compiladores', 'https://www.youtube.com/watch?v=gxlxHYv-9oo', 2);
INSERT INTO videos(id, nome, url, id_trilha) VALUES (4, 'Problemas simples de Grafos', 'https://www.youtube.com/watch?v=Dx7CNMxRuV4', 1);
